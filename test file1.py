...
Mecque = Deque()
print('The items in the array: ', Mecque.display_items())
print('Is the array empty?', Mecque.isEmpty())
print('Is the array full?', Mecque.isFull())
print('What is the size of the array?', Mecque.size())
...
for i in range(N//2):
    bonus = random.randint(1,100)
    Mecque.add_to_rear(bonus)
print(Mecque.display_items())
...
for i in range(50):  
    if items > 0 and items <= 0.1:
        geeb = random.randint(1,100)
        print('The random number generated between 1 and 100:', geeb)
        Mecque.add_to_front(geeb)
    
    if items > 0.1 and items <= 0.7:        
        geeb = random.randint(1,100)
        print('The random number generated between 1 and 100:', geeb)
        Mecque.remove_from_front()
    
    if items > 0.7 and items <= 0.8:
        geeb = random.randint(1,100)
        print('The random number generated between 1 and 100:', geeb)
        Mecque.add_to_rear(geeb)
     
    if items > 0.8 and items <= 1:
        geeb = random.randint(1,100)
        print('The random number generated between 1 and 100:', geeb)
        Mecque.remove_from_rear()
